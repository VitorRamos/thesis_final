...
\section{Fitting the Models} \label{subsec:fitting}
...
\end{figure}
\subsection{Frequency $\times$ Input}
...
\section{Overheads on Training} \label{subsec:overhead}
