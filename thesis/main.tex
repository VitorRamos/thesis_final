...
\umonsAuthor{Vitor Ramos Gomes \textsc{SILVA}}
\umonsTitle{Energy aware high-performance computing}
\umonsDocumentType{A DISSERTATION SUBMITTED TO THE ELECTRONICS AND MICROELECTRONICS DEPARTMENT OF MONS UNIVERSITY IN PARTIAL FULFILLMENT OF THE REQUIREMENTS FOR THE DEGREE OF DOCTOR IN ENGINEERING SCIENCES AND TECHNOLOGY}
%\umonsSupervisor{Supervisor\\ Carlos Alberto \textsc{VALDERRAMA}\\
%				 Co-supervisor\\ Pierre \textsc{MANEBACK}}
\umonsSupervisor{
 		Thesis committee:\\
 		Supervisor: Prof. Carlos Alberto \textsc{VALDERRAMA}\\
 		Co-supervisor: Prof. Pierre \textsc{MANEBACK}\\
 		Prof. Thierry \textsc{DUTOIT}\\
 		Prof. Sidi \textsc{MAHMOUDI}\\
 		Prof. Samuel \textsc{XAVIER-DE-SOUZA}
}
\umonsDate{April 2021}
...
\include{model_analysis/model_analysis}
