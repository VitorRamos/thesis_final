...
\begin{figure}[htb!]
	...
	\centerline{\includegraphics[width=\columnwidth]{energy/completo_dedup_4.png}}
    \caption{Dedup.}
	\label{fig:en_eq_dedup}
    \end{subfigure}
    %
    \begin{subfigure}[b]{0.48\textwidth}
    	\centerline{\includegraphics[width=\columnwidth]{energy/completo_rtview_4.png}}
        \caption{Raytrace.}
    	\label{fig:en_eq_rtview}
    \end{subfigure}
    %
    \begin{subfigure}[b]{0.48\textwidth}
    	\centerline{\includegraphics[width=\columnwidth]{energy/completo_swaptions_1.png}}
        \caption{Swaptions.}
    	\label{fig:en_eq_swaptions}
    \end{subfigure}
    \caption{Example fit for a specific input size: Dedup (a), Raytrace (b) and Swaptions (c). “measured values” are the sensor data and “minimum energy” is the minimum energy model prediction.
    }
\end{figure}
